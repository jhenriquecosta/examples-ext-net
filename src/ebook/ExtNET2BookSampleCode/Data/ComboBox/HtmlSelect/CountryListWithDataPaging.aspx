...
<script runat="server">
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		List<CountryInfo> data = CountryInfo.GetData(0, CountryInfo.TotalDataCount);

		store.DataSource = data;
		store.DataBind();

		var manager = ResourceManager.GetInstance();
		foreach (CountryInfo countryInfo in data)
		{
...
<html>
	...
	<body>
		...
		<ext:ComboBox 
			...
			PageSize="5">
			<Store>
				<ext:Store runat="server" IsPagingStore="true" PageSize="5">
					<Model>
