<%@ Page Language="C#" %>
<%@ Import Namespace="ExtNET2BookSampleCode.Data.DataView.Simple" %>
<script runat="server">
	protected void EmployeeStore_ReadData(object sender, StoreReadDataEventArgs e)
	{
		...
		e.Total = employees.TotalRecords;

		EmployeeStore.DataSource = employees.Data;
	...
	<ext:Panel runat="server" Title="Employees" Icon="Group" AutoScroll="true" Width="500" Height="330">
		<Items>
			<ext:DataView runat="server" ItemSelector=".info">
				<Store>
					<ext:Store Id="EmployeeStore" runat="server" PageSize="5" OnReadData="EmployeeStore_ReadData">
						<Model>
