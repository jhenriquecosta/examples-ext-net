...
<body>
	...
	<ext:GridPanel runat="server" Title="Simple Grid" Height="320" Width="500">
		<Store>
			<ext:Store Id="Store1" runat="server" PageSize="10" RemoteSort="true" WarningOnDirty="true">
				<Model>
		...
		<TopBar>
			<ext:Toolbar>
				<Items>
					...
					<ext:Button Icon="Delete" Text="Cancel">
						<Listeners>
							<Click Handler="#{Store1}.rejectChanges();" />
						</Listeners>
					</ext:Button>
				</Items>
			</ext:Toolbar>
