...
<body>
	<form runat="server">
		...
		<ext:Window 
			...
			Layout="FitLayout">
			<Items>
				<ext:TabPanel Border="false" DefaultBorder="false" TabPosition="Bottom">
					<Items>
						...
						<ext:Panel Layout="border" Title="Border" Icon="ApplicationSideList">
							<Items>
								<ext:Panel Region="West" Width="150" Title="West" Collapsible="true" Split="true" />
