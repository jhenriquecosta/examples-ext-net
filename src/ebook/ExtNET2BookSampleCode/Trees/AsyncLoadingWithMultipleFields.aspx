...
<html>
	<head runat="server">
		...
		<style>
			...
			.dir-info { background:#f5f5f5; padding:10px; border-top:3px double #dcdcdc!important; border-bottom:1px solid #dcdcdc!important; }
	...
	<body>
		...
		<ext:TreePanel Id="IconFolderTree"
			...
			<DockedItems>
				<ext:Panel Dock="bottom" height="75" BodyCls="dir-info">
					<Tpl>
						<Html>
